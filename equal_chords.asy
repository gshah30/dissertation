...
for(int i=0; i < lines.length; i=i+1) {
  ...
  draw(chord_endpoints[0].coordinates -- chord_endpoints[1].coordinates, invisible, triple_central_marker);
  ...
  draw(origin -- pointss[i][0].coordinates, dashed+light_pen, double_light_central_marker);
